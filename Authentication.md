...
* The password must be sent in the body, in two different form fields (password & passwordMd5). password should be an **Sha1**, while passwordMd5 should be an **Sha1**. 
